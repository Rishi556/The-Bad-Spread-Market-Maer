...
let getPrices = require("./get_prices.js")
  ...
  setTimeout(() => {
    ...
    axios.post(rpcAPI, queryBalance).then((res) => {
      ...
      if (balance > requiredAmount){
        ...
        hive.broadcast.customJson(config.privateActiveKey, [config.username], null, "ssc-mainnet-hive", JSON.stringify(orderJSON), (err, result) => {
          if (err){
